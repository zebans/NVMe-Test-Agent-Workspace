# ZNS-Modified Read - Opcode 02h

ZNS 1.1 overlay reference for the NVM Read command.

Use this folder when the question is about ZNS-specific Read behavior: zone boundary or Offline zone status.
