# ZNS-Modified Write Uncorrectable - Opcode 04h

ZNS 1.1 overlay reference for the NVM Write Uncorrectable command.

Use this folder when the question is about ZNS-specific Write Uncorrectable behavior: zone boundary, target zone state, write pointer validity, active/open resource limits, or ZNS status values `B8h`-`BEh`.
