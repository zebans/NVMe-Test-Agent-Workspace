# ZNS-Modified Write Uncorrectable Status Reference

Additional ZNS statuses from ZNS Figure 20:
...
Base Write Uncorrectable statuses remain owned by the NVM Command Set.
