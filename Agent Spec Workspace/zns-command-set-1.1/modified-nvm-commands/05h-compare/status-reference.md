# ZNS-Modified Compare Status Reference

Additional ZNS statuses from ZNS Figure 13:
...
| `BCh` | Zone Invalid Write | ZNS invalid write condition applies. |
...
Base Compare statuses remain owned by the NVM Command Set.
